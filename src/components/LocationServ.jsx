...
const LocationServ = () => {
    ...
    <div>
        <div>
            {/* Lokasi Pengabdian */}
            <div className="lokasi-pengabdian w-screen h-fit md:h-screen md:pt-28 px-10 md:px-30">
                ...
                <div className="box-2-lokasi flex flex-col md:flex-row justify-center items-center gap-5 md:gap-10 md:px-10 w-full h-fit">
                    <div data-aos="fade-right" className="md:w-1/2 w-full h-full transition-transform duration-500 hover:scale-105">
                        <iframe 
                    ...
                    <div data-aos="fade-left" className="md:p-4 md:w-1/2 h-full bg-white/45 backdrop-blur-[15px] border border-white shadow-[1px_1px_15px_rgba(0,0,0,0.25)] dark:shadow-[1px_1px_15px_rgba(255,255,255,0.5)] rounded-2xl text-primary-text dark:text-white transition-transform duration-500 hover:scale-105">
